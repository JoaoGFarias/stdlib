...
"Js","invalid option. `%s` option must be a negative integer. Option: `%s`.","TypeError"
"Jt","invalid argument. Specified dimension index is out-of-bounds. Must be on the interval: [-%u, %u]. Value: `%d`.","RangeError"
